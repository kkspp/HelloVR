...
public class ChangeSignal : MonoBehaviour {
	...
	void Update () {
        ...
        Debug.DrawRay(signalBox.position, -signalBox.right * 40.0f + Vector3.down*5.5f, Color.green);

        if (Physics.Raycast(signalBox.position, -signalBox.right * 40.0f + Vector3.down * 5.5f, out hit, 40.0f))
        {
